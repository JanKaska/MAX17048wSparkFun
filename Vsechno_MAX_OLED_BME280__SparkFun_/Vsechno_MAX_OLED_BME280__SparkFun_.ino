/*
 * EXAMPLE CODE FOR MAX17048, BME280 and OLED display with SH1106 driver IC 
 * Reading SOC from MAX17048 and values from BME280 and displaying them on the OLED.
 *
...
#include <SparkFun_MAX1704x_Fuel_Gauge_Arduino_Library.h> //Nutné stáhnout knihovnu pro MAX17048 - http://librarymanager/All#SparkFun_MAX1704x_Fuel_Gauge_Arduino_Library
...
SFE_MAX1704X lipo(MAX1704X_MAX17048); //Nastavý Pwr modul MAX17048 
...
void setup() {
  ...
  lipo.begin(); //připojí čip MAX17048 k desce
  lipo.quickStart();
...
void loop() {
BatteryStatus(lipo.getSOC()); //Zobrazí momentální stav baterie v levém horním rohu
